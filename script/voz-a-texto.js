		...
		recognition.onresult = function (event) {
            ...
            for (var i = event.resultIndex; i < event.results.length; ++i) {
                if (event.results[i].isFinal) {
                   ...
                   //procesarrespuesta(texto_respuesta_microfono);
                } else {
            ...
            respuesta.value = texto_respuesta_microfono; 


            if (texto_respuesta_microfono.indexOf('terminar') != -1)
                recognition.stop();
        };


        function procesarrespuesta (variable) {

        	texto_respuesta_microfono = variable;
